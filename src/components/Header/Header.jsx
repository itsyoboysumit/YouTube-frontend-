        ...
        <header className="fixed top-0 left-0 right-0 bg-[#0f0f0f] text-white flex justify-between items-center px-4 py-2 z-50">
            ...
            <div className="flex items-center space-x-4">
                ...
                <button className="p-2 rounded-full hover:bg-zinc-800 relative">
                    <Bell size={24} />
                    <span className="absolute top-1 right-1 bg-red-600 text-white text-xs rounded-full px-1.5 py-0.5">3</span>
                </button>
                <button>
                    <img src="https://placehold.co/40x40/7e22ce/ffffff?text=U" alt="User Avatar" className="rounded-full" />
                </button>
            </div>
        </header>
    );
